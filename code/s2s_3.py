...
# Adagrad
# First update language model, then update encoder
...
class RNNLM(object):
    ...
    def __init__(self, nh, nw):
        ...
        #bundle
        self.params1 = [self.wxg_1, self.whg_1, self.wxi_1, self.whi_1,
                self.wxf_1, self.whf_1, self.wxo_1, self.who_1, self.bg_1,
                self.bi_1, self.bf_1, self.bo_1, self.h0_1, self.c0_1]
        self.params_acc1 = [self.wxg_acc_1, self.whg_acc_1, self.wxi_acc_1,
                self.whi_acc_1, self.wxf_acc_1, self.whf_acc_1, self.wxo_acc_1,
                self.who_acc_1, self.bg_acc_1, self.bi_acc_1, self.bf_acc_1,
                self.bo_acc_1, self.h0_acc_1, self.c0_acc_1]

        self.params2 = [self.wxg_2, self.whg_2, self.wxi_2, self.whi_2, self.wxf_2,
                self.whf_2, self.wxo_2, self.who_2, self.w_2, self.bg_2,
                self.bi_2, self.bf_2, self.bo_2, self.b_2]
        self.params_acc2 = [self.wxg_acc_2, 
                self.whg_acc_2, self.wxi_acc_2, self.whi_acc_2, self.wxf_acc_2,
                self.whf_acc_2, self.wxo_acc_2, self.who_acc_2, self.w_acc_2,
        ...
        sentence_gradients = [T.grad(sentence_nll, param) for param in
                self.params1+self.params2]

        #Adagrad
        sentence_updates = []
        for param_i, grad_i, acc_i in zip(self.params1+self.params2,
                sentence_gradients, self.params_acc1+self.params_acc2):
    ...
    def save(self, folder):
        for param in self.params1+self.params2:
